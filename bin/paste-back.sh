...
# keystroke (Ctrl+Shift+V for terminals, Ctrl+V otherwise).
# Unlike v1 there is no popup window to hide here: rofi has already exited
# by the time tab-mode.sh hands over the selection.
set -uo pipefail
